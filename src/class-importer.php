...
class Importer {
	...
	/**
	 * Logs the last import date and time.
	 *
	 * @return void
	 */
	 ...
	 * @param string $taxonomy	The taxonomy that the term belongs to.
	 * @param array  $args		Additional arguments to pass along to the term.
	 *
	 * @return array|\WP_Error The inserted term data or error if something went wrong.
	 */
